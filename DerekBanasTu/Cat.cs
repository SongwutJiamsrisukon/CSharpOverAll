...
namespace DerekBanasTu
{
    class Cat:Animal
    {
        ...
        public Cat() : base()//initial Animal()
        {
            this.favFood = "No Favorite Food";
        }

        public Cat(double height, double weight, string name, string sound, string favFood) : base(height, weight, name, sound)//initial Animal(double height, double weight, string name, string sound)
        {
        ...
        {
            return "Number of Cats: " + numOfSubAnimals;
        }
